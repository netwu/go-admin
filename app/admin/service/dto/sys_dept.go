...
type SysDeptGetPageReq struct {
	...
	ParentId int    `form:"parentId" search:"type:exact;column:parent_id;table:sys_dept" comment:"上级组织"` //上级组织
	DeptPath string `form:"deptPath" search:"type:exact;column:dept_path;table:sys_dept" comment:""`     //路径
	DeptName string `form:"deptName" search:"type:exact;column:dept_name;table:sys_dept" comment:"组织名称"` //组织名称
...
type SysDeptInsertReq struct {
	...
	ParentId int    `json:"parentId" comment:"上级组织" vd:"?"`                         //上级组织
	DeptPath string `json:"deptPath" comment:""`                                    //路径
	DeptName string `json:"deptName" comment:"组织名称" vd:"len($)>0"`                  //组织名称
